...
Pour l'exemple de lecture, la spécialité est celle qui a été le plus choisie par les élèves.
...
- Parmi les bacheliers de 2021, 265 milliers ont suivi Mathématiques en Première 
(environ deux tiers) et 154 milliers en Terminale (environ un tiers).
- Parmi les bacheliers de 2021 ayant suivi Mathématiques en Première, 58% l'ont 
suivie en Terminale, 65% on suivi Physique Chimie en Première et 28% en Terminale.
