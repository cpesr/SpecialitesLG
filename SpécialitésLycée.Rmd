...
Remerciements : sur une idée de Marc de Falco, avec l'aide de Florent Figon, Romain Biard et Cédric Hugrée.


# Exemple de lecture

```{r exemple, out.height="50%", fig.asp=8/16}
    plots(2021,"SES")
```
## Exemples de lecture

- Figure de gauche : _Parmi tous les élèves préparant le Baccalauréat général 2021, 151 milliers ont suivi SES en Première (environ 40%) et 123 milliers en Terminale (environ un tiers)_.
- Figure de droite, en noir : _Pour 100 élèves ayant suivi SES ___en Première___, 82 ont un cursus 
complet SES en l'ayant suivie en Terminale, 58 ont aussi suivi Histoire Géo Politique
en Première, et 36 ont un cursus complet SES + Histoire Géo Politique_.
- Figure de droite, en blanc : _Pour 100 élèves ayant suivi SES ___en Terminale___, 71 ont suivi 
Histoire Géo Politique au moins en Première et 44 ont un cursus complet SES + Histoire Géo Politique_.
